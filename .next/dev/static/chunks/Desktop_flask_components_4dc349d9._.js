...
function DashboardSection() {
    ...
    const [togglingMode, setTogglingMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$flask$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$flask$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardSection.useEffect": ()=>{
            ...
            fetch(`${apiUrl}/sensor-mode`).then({
                "DashboardSection.useEffect": (r)=>r.json()
            }["DashboardSection.useEffect"]).then({
                "DashboardSection.useEffect": (d)=>setSensorMode(d.mode === 'mq7' ? 'mq7' : 'mq6')
            }["DashboardSection.useEffect"]).catch({
                "DashboardSection.useEffect": ()=>{}
            }["DashboardSection.useEffect"]);
        }
    }["DashboardSection.useEffect"], []);
...
_s(DashboardSection, "CvWBD6fwxa8PSIyBASxADpGqQUs=");
_c = DashboardSection;
